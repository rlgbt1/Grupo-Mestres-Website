...
const copy = {
  pt: {
    ...
    body: 'A Fazenda Ebbanus Britus, localizada em Icolo e Bengo, desenvolve actividades de criação de gado e produção hortícola. Representa a presença do Grupo Mestres no sector agrícola e o seu compromisso com o desenvolvimento sustentável da agropecuária em Angola.',
  ...
  en: {
    ...
    overview: 'Overview',
    heading: 'Fazenda Ebbanus Britus',
    body: 'Fazenda Ebbanus Britus, located in Icolo e Bengo, carries out livestock farming and vegetable production. It represents Grupo Mestres’ presence in the agricultural sector and its commitment to the sustainable development of agribusiness in Angola.',
    location: 'Icolo e Bengo, Estrada de Catete',
