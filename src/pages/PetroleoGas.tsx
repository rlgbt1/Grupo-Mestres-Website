...
const copy = {
  pt: {
    ...
    body: 'O Grupo Mestres actua no sector de petróleo e gás através de parcerias estratégicas com operadores estabelecidos no mercado angolano, prestando apoio logístico e técnico a actividades offshore e onshore. Esta é uma das frentes onde o Grupo se posiciona como o parceiro local de confiança para empresas estrangeiras e nacionais que procuram operar em Angola.',
    how: 'Como Operamos',
    partnerships: 'Parcerias Estratégicas',
    cardTitle: 'Colaboração com Operadores Offshore e Onshore',
  ...
  en: {
    ...
    body: 'Grupo Mestres operates in oil and gas through strategic partnerships with established operators in the Angolan market, providing logistical and technical support for offshore and onshore activities. This is one of the fronts where the Group positions itself as the trusted local partner for foreign and domestic companies looking to operate in Angola.',
    how: 'How We Operate',
    partnerships: 'Strategic Partnerships',
    cardTitle: 'Collaboration with Offshore and Onshore Operators',
